...
- [x] Expose explicit config-driven compression through the C FFI via `dfp_encode_configured`, including raw sync-flush offsets and LZ77/memLevel/tokenization settings (2026-05-25 11:31 EDT)
